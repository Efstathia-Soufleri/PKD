...
local_args['pretrained'] = "./checkpoints/kinetic400/resnet50_tsn_8f.pth.tar"  #./pretrained/resnet50_tsn_8f.pth.tar
            ...
            if epoch % args.eval_freq == 0 or epoch == args.epochs - 1:
                ...
                if is_best or epoch % SAVE_FREQ == 0:
                    save_checkpoint(
                        ...
                        is_best,
                        filename='checkpoint_TEAM_NET_'+str(args.split)+'_.pth.tar')
                print('Best Testing Results: {}'.format(best_prec1))
    else:      
        criterion = torch.nn.CrossEntropyLoss().cuda()
        args.teacher_weight = "./checkpoints/kinetic400/resnet50_tsn_8f.pth.tar"
...
def save_checkpoint(state, is_best, filename):
    ...
    if is_best:
        best_name = '_'.join((args.arch, 'tsn_{}f_TEAM_NET_'+str(args.split)+'_.pth.tar'.format(args.num_segments)))
