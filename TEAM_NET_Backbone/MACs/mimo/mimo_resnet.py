'''
Code form torch uncertainty
https://github.com/ENSTA-U2IS/torch-uncertainty/blob/main/torch_uncertainty/models/resnet/mimo.py
'''

import torch
from einops import rearrange

from mimo.std import _BasicBlock, _Bottleneck, _ResNet
