...
class TEAM_Net(nn.Module):
    def __init__(self, num_class, num_segments, 
        ...
        self._num_segments = num_segments
        self.I_model = TeamNetModel(num_class, num_segments, representation='iframe',
                              base_model=base_model, is_shift=is_shift, shift_div=8,
                              dropout = dropout)
        self.MV_model = TeamNetModel(num_class, num_segments, representation='mv',
                              base_model='resnet18', is_shift=is_shift, shift_div=8,
                              dropout = dropout)
        self.R_model = TeamNetModel(num_class, num_segments, representation='residual',
                              base_model='resnet18', is_shift=is_shift, shift_div=8,
                              dropout = dropout)
        self._ratio = 4
        if is_shift:
...
if __name__ == '__main__':
    model = TeamNetModel(101, 3, 'iframe',
