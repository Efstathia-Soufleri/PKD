            ...
            if epoch % args.eval_freq == 0 or epoch == args.epochs - 1:
                ...
                if is_best_IC1:
                    save_checkpoint(
                        ...
                        is_best_IC1,
                        filename='checkpoint_I_frame_IC1_seed_'+str(args.random_seed)+'_split_'+str(args.split)+'.pth.tar')
                ...
                if is_best_IC2:
                    save_checkpoint(
                        ...
                        is_best_IC2,
                        filename='checkpoint_I_frame_IC2_seed_'+str(args.random_seed)+'_split_'+str(args.split)+'.pth.tar')
                ...
                if is_best_IC3:
                    save_checkpoint(
                        ...
                        is_best_IC3,
                        filename='checkpoint_I_frame_IC3_seed_'+str(args.random_seed)+'_split_'+str(args.split)+'.pth.tar')
...
def save_checkpoint(state, is_best, filename):
    ...
    if is_best:
        best_name = f'{args.arch}_tsn_{args.num_segments}_TEAM_NET_{args.split}_seed_{args.random_seed}_I_frame_IC.pth.tar'
