...
def main():
    ...
    # checkpoint = torch.load('./checkpoints/kinetics_resnet50_rolled_model_8f_checkpoint.pth.tar')
    # checkpoint = torch.load('./checkpoints/resnet50_rolled_model_8f_checkpoint.pth.tar')
    checkpoint = torch.load('./checkpoints/resnet50__rolled_model__8f_checkpoint.pth.tar')
