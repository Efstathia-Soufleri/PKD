...
def main():
    ...
    # checkpoint = torch.load('./checkpoints/resnet18_mv__rolled_model__8f_checkpoint.pth.tar')
    print("Loaded the pretrained on kinetics model.")

    # model.load_state_dict(torch.load('./checkpoints/resnet18_mv__rolled_model__8f_checkpoint.pth.tar')['state_dict'])
    model.load_state_dict(torch.load('./checkpoints/resnet18_mv__rolled_model_v2__8f_checkpoint_v2.pth.tar')['state_dict'])
