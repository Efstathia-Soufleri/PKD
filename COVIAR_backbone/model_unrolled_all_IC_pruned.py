...
class model_unrolled_all_IC_pruned(nn.Module):
    ...
    def __init__(self, num_class, num_segments, representation, 
        ...
        # IC1
        self.IC1_features = nn.Sequential(nn.Conv2d(in_channels=64, out_channels=32, kernel_size=3, stride=1, padding=1, bias=False),
                            nn.BatchNorm2d(32))
        self.IC_adaptive_avg_pool = nn.AdaptiveAvgPool2d(4)
        self.IC1_classifier = nn.Linear(512, num_class)
