...
def main():
    ...
    # model_IC = torch.nn.DataParallel(model_IC, device_ids = [0,1,2]).cuda()
    ...
    params1 = torch.nn.ParameterList([  model_IC.module.IC1_features[0].weight, 
                                        ...
                                        model_IC.module.IC1_classifier.bias])
    ...
    params2 = torch.nn.ParameterList([  model_IC.module.IC2_features[0].weight, 
                                        ...
                                        model_IC.module.IC2_classifier.bias])
    ...
    params3 = torch.nn.ParameterList([  model_IC.module.IC3_features[0].weight, 
                                        ...
                                        model_IC.module.IC3_classifier.bias])
    ...
    for epoch in range(args.epochs):
        ...
        train(train_loader, model_IC, criterion, optimizer_IC1, optimizer_IC2,
        ...
        if is_best_IC1:
            save_checkpoint(
                ...
                is_best_IC1,
                filename='checkpoint_CE_IC1_seed_'+str(args.random_seed)+'.pth.tar')
        ...
        if is_best_IC2:
            save_checkpoint(
                ...
                is_best_IC2,
                filename='checkpoint_CE_IC2_seed_'+str(args.random_seed)+'.pth.tar')
        ...
        if is_best_IC3:
            save_checkpoint(
                ...
                is_best_IC3,
                filename='checkpoint_CE_IC3_seed_'+str(args.random_seed)+'.pth.tar')
...
def train(train_loader, model_IC, criterion, optimizer_IC1, optimizer_IC2,
              optimizer_IC3, epoch, cur_lr1, cur_lr2, cur_lr3):
    ...
    model_IC.train()
    # print("before train_loader, time:", time.time())
